...
if __name__ == "__main__":
    test = [{
        ...
        "source_url": "https://example.com/test-aml-article-v2",
        "source_name": "Reuters",
        "published_date": "10-03-2026",
        "country": "Australia",
        "region": "Asia-Pacific",
        "summary": "Test summary of an AML enforcement action.",
        "aml_typology": "Shell companies",
        "category": "typology",
        "tags": ["shell-company", "australia", "enforcement"],
        "image_url": None,
        "raw_snippet": "Original snippet.",
    }]
    count = upload_articles(test)
    print(f"Uploaded {count} test articles")
